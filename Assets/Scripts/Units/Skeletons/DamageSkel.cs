...
public class DamageSkel : MonoBehaviour
{
    private bool hasDealtDamageThisAttack = false;
    private SkeletStMan manager;
    ...
    private void Awake()
    {
        manager = GetComponentInParent<SkeletStMan>();
    }
    ...
    public void Skel_ResetDamageFromAnimation()
    {
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.TryGetComponent<Health>(out Health enemyHealth))
        {
            ...
            {
                enemyHealth.ApplyDamage(damageAmount, "враг-skelet");
                hasDealtDamageThisAttack = true;
            }
        }
    }
